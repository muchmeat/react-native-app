...
import com.ruixin.ffjw.cameraView.cameralibrary.util.AngleUtil;
import com.ruixin.ffjw.cameraView.cameralibrary.util.CameraParamUtil;
import com.ruixin.ffjw.cameraView.cameralibrary.util.CheckPermission;
import com.ruixin.ffjw.cameraView.cameralibrary.util.DeviceUtil;
...
//
        ...
        mCamera.takePicture(null, null, new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                imgFileAbsPath = FileUtil.saveBitmap(bitmap);

                if (callback != null) {
                    if (nowAngle == 90 || nowAngle == 270) {
                        callback.captureResult(bitmap, true, imgFileAbsPath);
                    } else {
                        callback.captureResult(bitmap, false, imgFileAbsPath);
                    }
                }
            }
        });
...
//        }
        ...
        videoFileName = "video_" + FileUtil.getFileName() + ".mp4";
    ...
    public interface TakePictureCallback {
        void captureResult(Bitmap bitmap, boolean isVertical, String url);
    }
