...
public class CaptureLayout extends FrameLayout {
    ...
    public static final String TXT_ONLY_CAPTURE = "轻触拍照";
    public static final String TXT_ONLY_RECORDER = "长按摄像";
    public static final String TXT_ONLY_BOTH = "轻触拍照，长按摄像";
