...
import com.ruixin.ffjw.R;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.CaptureListener;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.ClickListener;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.ErrorListener;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.JCameraListener;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.ReturnListener;
import com.ruixin.ffjw.cameraView.cameralibrary.listener.TypeListener;
import com.ruixin.ffjw.cameraView.cameralibrary.state.CameraMachine;
...
import com.ruixin.ffjw.cameraView.cameralibrary.util.ScreenUtils;
import com.ruixin.ffjw.cameraView.cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (event.getPointerCount() == 2) {
                    Log.i("cameraView", "ACTION_DOWN = " + 2);
                }
                break;
    ...
    public void confirmState(int type) {
        switch (type) {
            ...
            case TYPE_PICTURE:
                mPhoto.setVisibility(INVISIBLE);
                if (jCameraLisenter != null) {
                    jCameraLisenter.captureSuccess(captureBitmap, imgUrl);
                }
                break;
            case TYPE_SHORT:
                break;
    ...
    @Override
    public void showPicture(Bitmap bitmap, boolean isVertical, String url) {
        imgUrl = url;
        if (isVertical) {
