...
class Detail extends Component {
    ...
    render() {
        return(
            <View style={[styles.detail.container,{backgroundColor:"#EEE"}]}>
                <ScrollView>
                    <GroupTitle title={"主要信息"}/>
                    <View style={styles.group2}>
                        <View style={[styles.detail.imgRow,{marginBottom:1,flexDirection:"column",height:115,justifyContent:"flex-start",alignItems:"flex-start"}]}>
